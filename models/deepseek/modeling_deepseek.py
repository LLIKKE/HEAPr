...
class MoEGate(nn.Module):
    ...
    def forward(self, hidden_states):
        ...
        #topk_weight, topk_idx =repeat_topk(scores, top_k=self.top_k, fixed_top_n=5)
...
class DeepseekAttention(nn.Module):
    ...
    def forward(
        ...
        #if self.layer_idx not in gate_weight:
        #    gate_weight[self.layer_idx]={"scores":None,"attn_weights":None}
        #print(self.attention_dropout)
        #gate_weight[self.layer_idx]["attn_weights"].append(attn_weights[0].detach().cpu())
...
class DeepseekModel(DeepseekPreTrainedModel):
    ...
    def forward(
        ...
        #print(self._use_sdpa,self._use_flash_attention_2,)
...
class DeepseekForCausalLM(DeepseekPreTrainedModel):
    ...
    def forward(
        ...
        #torch.save(gate_weight,"gate_weight_deepseek.pt")
